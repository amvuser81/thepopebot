...
import { createAgentJobTool, updatePopebotTool, headlessCodingTool } from './tools.js';
...
export async function getAgentChat() {
  if (!globalThis.__popebotAgentChat) {
    ...
    const tools = [createAgentJobTool, updatePopebotTool];
 ...
 * Uses a static headlessCodingTool that reads context from runtime.configurable.
 */
